# GUI Docker (Ubuntu 20.04)
Repo is forked from bandi13's gui docker [repo](https://github.com/bandi13/gui-docker). Using ubuntu 20.04 as a base
...
`docker run --shm-size=256m -it -p 5901:5901 -e VNC_PASSWD=123456 nkostic/gui-docker`
...
`docker run --shm-size=256m -it -p 5900:5900 -e VNC_PASSWD=123456 nkostic/gui-docker`
